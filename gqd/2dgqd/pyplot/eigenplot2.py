...
num = int(sys.argv[1])
eigenvalue = "/home/qqgu/work/gqd/2dgqd/eigva.dat"
eig = linecache.getline(eigenvalue,num)
print("eigenvalue is ",float (eig)*15)
print("eigenvector is shown as")


eigenvector = "/home/qqgu/work/gqd/2dgqd/eigve.dat"
